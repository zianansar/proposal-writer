  ...
  const handleNext = async () => {
    if (currentStep < totalSteps - 1) {
      ...
      try {
        ...
        setError(
          typeof err === "string" ? err : "Failed to save your preferences. Please try again.",
        );
      } finally {
        setIsSaving(false);
      }
    ...
    >
      <CardHeader>
        <div className="flex justify-between items-center">
          <CardTitle className="text-[var(--color-text-primary)]" id="calibration-title">
            Quick Calibration
          </CardTitle>
          <span
      ...
      <CardContent className="space-y-6">
        ...
        {error && (
          <div
            className="flex items-center gap-2 p-3 bg-red-900/20 border border-red-500/50 rounded-lg text-red-400"
            role="alert"
          >
        ...
        <div className="flex justify-between pt-4">
          ...
          <Button
            ...
            className="bg-[#f97316] hover:bg-[#ea580c] text-white"
          >
            {currentStep === totalSteps - 1 ? (isSaving ? "Saving..." : "Finish") : "Next"}
          </Button>
        </div>
      </CardContent>
    </Card>
