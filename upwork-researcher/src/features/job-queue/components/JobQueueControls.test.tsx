...
describe('JobQueueControls', () => {
  ...
  it('calls onFilterChange when All button clicked', () => {
    ...
    render(<JobQueueControls {...defaultProps} onFilterChange={onFilterChange} filter="greenOnly" />);
  ...
  it('updates displayed counts when colorCounts changes', () => {
    ...
    rerender(
      <JobQueueControls {...defaultProps} colorCounts={{ green: 50, yellow: 30, red: 15, gray: 4 }} />
    );
