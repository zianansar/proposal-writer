...
describe('SearchFilterBar', () => {
  ...
  const renderBar = (overrides?: Partial<{
  ...
  it('resets all filters on clear click (AC-5)', () => {
    renderBar({ filters: { searchText: 'test', outcomeStatus: 'hired', dateRangeDays: 30, hookStrategy: 'social_proof' } });
  ...
  it('shows active filter count', () => {
    renderBar({ filters: { searchText: 'test', outcomeStatus: 'hired', dateRangeDays: 0, hookStrategy: '' } });
