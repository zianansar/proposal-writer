...
export { useSearchProposals, hasActiveFilters, activeFilterCount, DEFAULT_FILTERS } from './useSearchProposals';
...
export type { ProposalListItem, ProposalHistoryResponse, ProposalDetail, AnalyticsSummary, OutcomeCount, StrategyPerformance, WeeklyActivity } from './types';
