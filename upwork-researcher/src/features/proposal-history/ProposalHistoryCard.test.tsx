...
describe('ProposalHistoryCard', () => {
  ...
  it('calls onCardClick with proposal id on card click (Story 7.4)', () => {
    render(
      <ProposalHistoryCard proposal={mockProposal} style={mockStyle} onCardClick={mockOnCardClick} />
    );
  ...
  it('displays hired outcome with correct class', () => {
    ...
    render(
      <ProposalHistoryCard proposal={hiredProposal} style={mockStyle} />
    );
  ...
  it('displays response_received with formatted label', () => {
    ...
    render(
      <ProposalHistoryCard proposal={receivedProposal} style={mockStyle} />
    );
  ...
  it('outcome badge has accessible label', () => {
    ...
    render(
      <ProposalHistoryCard proposal={submittedProposal} style={mockStyle} />
    );
  ...
  it('clicking badge opens dropdown without calling onCardClick (AC-1, AC-3)', () => {
    render(
      <ProposalHistoryCard proposal={mockProposal} style={mockStyle} onStatusChange={mockOnStatusChange} onCardClick={mockOnCardClick} />
    );
  ...
  it('selecting status from dropdown calls onStatusChange (AC-2)', () => {
    render(
      <ProposalHistoryCard proposal={mockProposal} style={mockStyle} onStatusChange={mockOnStatusChange} />
    );
