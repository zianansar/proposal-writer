...
import { useSearchProposals, hasActiveFilters, activeFilterCount, DEFAULT_FILTERS } from './useSearchProposals';
...
describe('useSearchProposals', () => {
  ...
  const mockResponse: ProposalHistoryResponse = {
    proposals: [
      { id: 1, jobExcerpt: 'Job 1', previewText: 'Text 1', createdAt: '2026-01-01', outcomeStatus: 'pending', hookStrategyId: null },
    ],
    totalCount: 1,
    hasMore: false,
  };
