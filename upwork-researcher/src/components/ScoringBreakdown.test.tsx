...
describe("ScoringBreakdownCard", () => {
  ...
  it("displays correct quality labels at threshold boundaries - skills green", () => {
    ...
    renderWithProviders(
      <ScoringBreakdownCard breakdown={greenSkills} isExpanded={true} jobPostId={1} />,
    );
  ...
  it("displays correct quality labels at threshold boundaries - skills moderate", () => {
    ...
    renderWithProviders(
      <ScoringBreakdownCard breakdown={moderateSkills} isExpanded={true} jobPostId={1} />,
    );
  ...
  it("displays correct quality labels at threshold boundaries - skills poor", () => {
    ...
    renderWithProviders(
      <ScoringBreakdownCard breakdown={poorSkills} isExpanded={true} jobPostId={1} />,
    );
  ...
  it("displays correct quality labels at threshold boundaries - client reliable", () => {
    ...
    renderWithProviders(
      <ScoringBreakdownCard breakdown={reliableClient} isExpanded={true} jobPostId={1} />,
    );
  ...
  it("displays correct quality labels at threshold boundaries - client high risk", () => {
    ...
    renderWithProviders(
      <ScoringBreakdownCard breakdown={highRiskClient} isExpanded={true} jobPostId={1} />,
    );
  ...
  it("displays correct quality labels at threshold boundaries - budget good", () => {
    ...
    const { container } = renderWithProviders(
      <ScoringBreakdownCard breakdown={goodBudget} isExpanded={true} jobPostId={1} />,
    );
  ...
  it("displays correct quality labels at threshold boundaries - budget low", () => {
    ...
    renderWithProviders(
      <ScoringBreakdownCard breakdown={lowBudget} isExpanded={true} jobPostId={1} />,
    );
  ...
  it("shows recommendation text", () => {
    ...
    expect(
      screen.getByText(/Proceed with caution\. Review client history before applying\./),
    ).toBeInTheDocument();
  });

  it("does not render when isExpanded is false", () => {
    const { container } = renderWithProviders(
      <ScoringBreakdownCard breakdown={mockBreakdown} isExpanded={false} jobPostId={1} />,
    );
  ...
  it("handles null scores gracefully - skills not configured", () => {
    ...
    renderWithProviders(
      <ScoringBreakdownCard breakdown={nullSkills} isExpanded={true} jobPostId={1} />,
    );
  ...
  it("handles null scores gracefully - client not assessed", () => {
    ...
    renderWithProviders(
      <ScoringBreakdownCard breakdown={nullClient} isExpanded={true} jobPostId={1} />,
    );
  ...
  it("handles null scores gracefully - budget unknown", () => {
    ...
    renderWithProviders(
      <ScoringBreakdownCard breakdown={nullBudget} isExpanded={true} jobPostId={1} />,
    );
