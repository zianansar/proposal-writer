...
describe("ClientQualityBadge", () => {
  ...
  it("has aria-label for null state (NFR-14)", () => {
    ...
    const badge = screen.getByTestId("client-quality-badge");
    expect(badge).toHaveAttribute("aria-label", "Client quality score: Not available");
  });
  ...
  it("has correct aria-label with score and quality level (NFR-14)", () => {
    ...
    const badge = screen.getByTestId("client-quality-badge");
    expect(badge).toHaveAttribute("aria-label", "Client quality score: 85, high quality");
  });
  ...
  it('has "medium quality" aria-label for 60-79', () => {
    ...
    const badge = screen.getByTestId("client-quality-badge");
    expect(badge).toHaveAttribute("aria-label", "Client quality score: 70, medium quality");
  });
  ...
  it('has "high risk" aria-label for < 60', () => {
    ...
    const badge = screen.getByTestId("client-quality-badge");
    expect(badge).toHaveAttribute("aria-label", "Client quality score: 45, high risk");
  });
