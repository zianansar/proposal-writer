...
describe("HookStrategyCard", () => {
  ...
  it("should render strategy data correctly", () => {
    ...
    expect(screen.getByText("Lead with relevant experience and quantified results")).toBeInTheDocument();
    expect(screen.getByText(/"I've helped 12 clients in your industry achieve..."/)).toBeInTheDocument();
  ...
  it("should show checkmark when isSelected is true", () => {
    ...
    render(
      <HookStrategyCard {...mockStrategy} isSelected={true} onSelect={mockOnSelect} />
    );
